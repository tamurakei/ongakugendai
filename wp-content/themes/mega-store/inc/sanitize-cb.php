 ...
 */
function mega_store_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function mega_store_sanitize_css( $css ) {
 ...
 */
function mega_store_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function mega_store_sanitize_email( $email, $setting ) {
 ...
 */
function mega_store_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function mega_store_sanitize_html( $html ) {
 ...
 */
function mega_store_sanitize_image( $image, $setting ) {
 ...
 */
function mega_store_sanitize_nohtml( $nohtml ) {
 ...
 */
function mega_store_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function mega_store_sanitize_number_range( $number, $setting ) {
 ...
 */
function mega_store_sanitize_select( $input, $setting ) {
 ...
 */
function mega_store_sanitize_url( $url ) {
