...
define("SOCIAL2BLOG_SERVER_URL","http://splws.xkoll.com/api/donatella.php");
define("SOCIAL2BLOG_ACCESSURL", "http://splws.xkoll.com/api/access_token/proxysocial.php");
define("SOCIAL2BLOG_TWITTERCALLBACKURL", "http://splws.xkoll.com/api/access_token/twitterauthproxy.php?auth=ok");
define("SOCIAL2BLOG_DEBUG", get_option("social2blog_mod_debug")==1 ? "1" : "");
define("SOCIAL2BLOG_PREMIUMLINK", "http://www.social2blog.com/#premium");
define("SOCIAL2BLOG_LINK", "http://www.social2blog.com/");
...
function social2blog_adminscripts() {
        ...
        wp_enqueue_script('/js/social2blog.js');
}
...
function social2blog_deactivation(){
	...
	$url = "http://splws.xkoll.com/api/donatella.php?api_key=" . $apikey . "&act=deactivate";
	$ch = curl_init ();
...
<div class="notice social2blog_activate_notice">
	<div class="social2blog_activate">
		...
		<div  class="social2blog_activate_button_container">
				<form action="http://www.social2blog.com/activate.php" method="POST">
